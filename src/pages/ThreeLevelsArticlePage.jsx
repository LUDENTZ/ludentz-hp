...
const sections = [
  ...
  { id: 'maturity', title: '3段階は、組織の成熟度の階段でもある' },
  { id: 'faq', title: 'よくある質問' },
      ...
      <main>
        <article className="article">
          ...
          <div className="article-body">
            ...
            <section id="maturity">
              <h2>3段階は、組織の成熟度の階段でもある</h2>
              <p>
                この3つの型は「どれが進んでいるか」の優劣ではありませんが、組織のAI活用は自然とこの階段を登っていきます。
              </p>
              <p>
                最初は全業務COPILOTで構いません。人がAIと往復するうちに、「この業務、毎回同じ指示をしているな」という工程が見えてきます。それは手順が言語化された合図で、WORKFLOWに降ろせます。さらに運用が安定し、ゴール条件が明確に定義できた業務から、AGENTに渡せるようになります。
              </p>
              <p>
                つまり、<strong>COPILOTでの往復は、WORKFLOWとAGENTのための言語化プロセスを兼ねている</strong>のです。深く渡すほど、渡す回数は減り、人の手が空く。空いた手は、判断と、次の業務の言語化に使う。この循環が回り始めた状態が、私たちの考えるAX（AIトランスフォーメーション）です。
              </p>
            </section>
