        ...
        <article className="article">
          ...
          <div className="article-body">
            ...
            <section id="cost">
              ...
              <p>
                参考として、LUDENTZのマーケティングAX支援は助言のみ月20万円〜、伴走支援は月50万〜200万円で提供しています。ツール導入だけで済ませる場合との違いは、業務プロセスの再設計と定着支援が含まれるかどうかです。詳細は
                <a href="/marketing-ax/cost">費用相場の解説ページ</a>
                をご覧ください。
              </p>
            </section>
                    ...
                    <p>
                      {faq.q === '広告代理店でも活用できますか？' ? (
                        <>
                          ...
                          <a href="/marketing-ax/ad-operations">広告運用AX</a>
                          をご覧ください。
                        </>
                      ) : (
                        faq.a
